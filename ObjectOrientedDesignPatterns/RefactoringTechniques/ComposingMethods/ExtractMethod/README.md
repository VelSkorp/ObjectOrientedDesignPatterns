...
[**Problem Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/Problem.cs)

## Solution

Move this code to a separate new method (or function) and replace the old code with a call to the method.
[**Solution Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/Solution.cs)
