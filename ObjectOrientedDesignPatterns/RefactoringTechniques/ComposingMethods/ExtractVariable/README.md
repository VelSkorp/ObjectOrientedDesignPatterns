...
[**Problem Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractVariable/Problem.cs)

## Solution

Place the result of the expression or its parts in separate variables that are self-explanatory.
[**Solution Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractVariable/Solution.cs)
