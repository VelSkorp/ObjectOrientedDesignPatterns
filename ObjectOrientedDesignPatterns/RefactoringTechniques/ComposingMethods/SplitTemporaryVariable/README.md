...
[**Problem Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/SplitTemporaryVariable/Problem.cs)

## Solution

Use different variables for different values. Each variable should be responsible for only one particular thing.
[**Solution Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/SplitTemporaryVariable/Solution.cs)
...
- This refactoring technique is useful if you anticipate using [**Extract Method**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/README.md) later.
