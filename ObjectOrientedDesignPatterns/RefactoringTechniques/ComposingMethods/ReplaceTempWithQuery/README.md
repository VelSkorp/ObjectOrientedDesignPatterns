...
[**Problem Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ReplaceTempWithQuery/Problem.cs)
...
[**Solution Code**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ReplaceTempWithQuery/Solution.cs)

## Why Refactor

This refactoring can lay the groundwork for applying [**Extract Method**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/README.md) for a portion of a very long method.
...
2. Use [**Extract Method**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/README.md) to place the expression of interest in a new method. Make sure that this method only returns a value and doesn’t change the state of the object. If the method affects the visible state of the object, use Separate Query from Modifier.
