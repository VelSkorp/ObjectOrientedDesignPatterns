...
- To isolate `switch` and put it in the right class, you may need [**Extract Method**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/ExtractMethod/README.md) and then Move Method.
...
- Often `switch` operators are used by factory design patterns ([**Factory Method**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/FactoryMethod/README.md) or [**Abstract Factory**](ObjectOrientedDesignPatterns/RefactoringTechniques/ComposingMethods/AbstractFactory/README.md)) to select a created class.